...
static constexpr int DRIVE_CONTROLLER_RIGHT_JOYSTICK_X = 4;
static constexpr int DRIVE_CONTROLLER_DRIVE_AXIS_X = DRIVE_CONTROLLER_RIGHT_JOYSTICK_X;
...
static constexpr int DRIVE_TOGGLE_AUTO_INTAKE_BUTTON = DRIVE_CONTROLLER_RIGHT_BUMPER;
...
static constexpr int OPERATOR_INDEXER_FEED_REVERSE_BUTTON = OPERATOR_JOYSTICK_HAT_LEFT_TOP;

static constexpr int OPERATOR_INTAKE_REJECT_BUTTON = OPERATOR_JOYSTICK_HAT_LEFT_BOTTOM;
static constexpr int OPERATOR_INTAKE_FEED_ROBOT_BUTTON = OPERATOR_JOYSTICK_HAT_RIGHT_BOTTOM;
